...
This extension is provided as-is for educational and practical use. Based on the original work by various contributors to the Inkscape community.

## Contributing

Feel free to submit issues or improvements to this extension. The code is designed to be readable and maintainable for future Inkscape versions.